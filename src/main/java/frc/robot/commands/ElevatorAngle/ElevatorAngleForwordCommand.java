package frc.robot.commands.ElevatorAngle;
...
public class ElevatorAngleForwordCommand extends CommandBase{
    ...
    public ElevatorAngleForwordCommand(ElevatorAngleSubsystem elevator)
    {
  ...
  public void initialize() {
      _elevator.setManual(Motors.angle_move_precentage,false);
  }
